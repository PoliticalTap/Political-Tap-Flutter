...
/// [DynamicExpansionTile] to save and restore its expanded state when it is scrolled
/// in and out of view.
///
/// See also:
///
...
class _ExpansionTileState extends State<DynamicExpansionTile> with SingleTickerProviderStateMixin {
            ...
            child: Ink (
              child: ListTile(
                ...
                trailing: widget.trailing ?? RotationTransition(
                  turns: _iconTurns,
                  child: Icon(Icons.expand_more, color: widget.trailingColor,),
                ),
              ),
